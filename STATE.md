...
**Dernière action** : QA final sur la refonte UI rétro-arcade de `web/` validé localement autant que possible (`build`, `build:tic`, `preview`). Journal et état alignés sur la livraison.

**Prochaine étape** : Pousser la branche `web/v0.2-arcade`, puis surveiller la CI et le rendu GitHub Pages.
